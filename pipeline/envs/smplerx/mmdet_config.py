"""Configuration mmdet 2.x self-contained pour Faster R-CNN R50-FPN COCO.

Équivalent fonctionnel de configs/faster_rcnn/faster_rcnn_r50_fpn_1x_coco.py
de mmdetection 2.x, mais sans inheritance _base_ pour faciliter le chargement
hors du repo mmdet.

À utiliser avec le checkpoint :
